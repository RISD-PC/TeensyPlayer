...
void setup() {
  ...
  Serial.print(maxFilenameIndex);
  Serial.println(" The number of titles in array fileNameArray");

  Serial.print("maxFilenameIndex2 = ");
  Serial.print(maxFilenameIndex2);
  Serial.println(" The number of titles in array fileNameArray2");
...
void controlFileWithDistanceSensor() {
  ...
  // set to your desired max sensing distance
  ...
  if (distanceCM < distance_thresholdCM) {
    ...
    Serial.print(" indexS2 "); Serial.println(indexS2);
#endif

    if (!playSdWav1.isPlaying()) {
      // player1.playFileContinuously(indexS, fileNameArray, maxFilenameIndex2, &playSdWav1);
      // will play the file over until a new index is received - never stops until you call
      //  player1.stop() (get correct player).
      player1.playFileContinuously(indexS, fileNameArray, maxFilenameIndex, &playSdWav1);
    }

    // stop the file either of two ways
    // player1.stop(&playSdWav1);
    // playSdWav1.stop();
